...
public:
  ...
  void enableHedgeOnPerTryTimeout() {
    ...
    callbacks_.route_->route_entry_.hedge_policy_.additional_request_chance_ = envoy::type::FractionalPercent{};
    callbacks_.route_->route_entry_.hedge_policy_.additional_request_chance_.set_numerator(0);
    callbacks_.route_->route_entry_.hedge_policy_.additional_request_chance_.set_denominator(envoy::type::FractionalPercent::HUNDRED);
  }
...
TEST_F(RouterTest, HedgedPerTryTimeoutGlobalTimeout) {
  ...
  EXPECT_EQ(0, cm_.thread_local_cluster_.cluster_.info_->stats_store_
                    .counter("upstream_rq_hedge_abandoned")
                    .value());
  EXPECT_EQ(2, cm_.thread_local_cluster_.cluster_.info_->stats_store_
