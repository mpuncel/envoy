...
private:
  ...
  void onUpstream100ContinueHeaders(Http::HeaderMapPtr&& headers, UpstreamRequest* upstream_request);
  ...
  void onUpstreamHeaders(uint64_t response_code, Http::HeaderMapPtr&& headers, UpstreamRequest* upstream_request, bool end_stream);
  ...
  void handleNon5xxResponseHeaders(const Http::HeaderMap& headers, UpstreamRequest* upstream_request, bool end_stream);
